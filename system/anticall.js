...
await conn.sendMessage(from, {text: `*AUTO REJECT PANGGILAN*\n\nTerdeteksi Panggilan Dari @${from.split('@')[0]}\nAnda di blokir karna telah menelfon bot!`, mentions: [from] }, {quoted: virus})
await conn.updateBlockStatus(from, 'block')
if (from !== global.owner) return conn.sendMessage(global.owner, {text: `Terdeteksi @${from.split('@')[0]} telah menelfon bot`, mentions: [from]}, {quoted: global.f1('Notifikasi Panggilan', '')})
}
